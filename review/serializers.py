    ...
    def create(self, validated_data):
        try:
            ...
            raise serializers.ValidationError({
                'detail': "possible duplicate - You can't write two reviews to the same course. Try to update your first review"  # noqa
            })
...
class ReviewDetailSerializer(ReviewSerializer):
    ...
    Artiicle is a read only field so that we don't have to set it on each update  # noqa
    """
